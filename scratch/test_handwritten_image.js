...
// Use the newly configured gemini-3.5-flash-lite model
const genAI = new GoogleGenerativeAI(apiKey);
const model = genAI.getGenerativeModel({ model: 'gemini-3.5-flash-lite' });

const imagePath = path.join(__dirname, '../testing image.jpeg');
...
async function testImage() {
  console.log(`📸 [TEST]: Processing "testing image.jpeg" using gemini-3.5-flash-lite...`);
